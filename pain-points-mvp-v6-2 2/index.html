...
<head>
    ...
    <title>Niche Miner - Retro Variant</title>
                    ...
                    <div class="mb-8 relative">
                        <div class="bg-gradient-to-br from-orange-400 to-pink-500 p-4 border-4 border-black" style="box-shadow: 6px 6px 0 rgba(0,0,0,0.3);">
                            <div class="flex items-center gap-3">
                                <div class="w-12 h-12 flex items-center justify-center border-2 border-yellow-400 rounded">
                                    <img src="../assets/golden_pickaxe.png" alt="Pickaxe" class="w-10 h-10 object-contain">
                                </div>
                                <div>
                                    <span class="retro-title text-xs text-white" style="text-shadow: 2px 2px 0 rgba(0,0,0,0.5);">NICHE</span>
                                    <p class="pixel-text text-lg text-yellow-300 leading-none" style="text-shadow: 2px 2px 0 rgba(0,0,0,0.3);">MINER</p>
                                </div>
                            </div>
                        </div>
            ...
            <main class="flex-1 md:ml-0">
                ...
                <header class="md:hidden flex items-center justify-between p-4 border-b-4 border-brown-600 bg-orange-100">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="retro-title text-xs">NICHE MINER</span>
                    </div>
                    <button class="p-2">
                        <i data-lucide="sun" class="w-4 h-4"></i>
                    </button>
